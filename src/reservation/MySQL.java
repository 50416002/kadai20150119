...
public class MySQL {
   ...
   String server, dbname, url, user, password;
    ...
    public MySQL() {
        ...
        this.dbname  = "50416002";         // データベース名;

        this.url = "jdbc:mysql://" + server + "/" + dbname + "?useUnicode=true&characterEncoding=UTF-8";

        this.user = "50416002";         // データベース作成ユーザ名;

        this.password  = "50416002";     // データベース作成ユーザパスワード;
...
public ResultSet showReservation(){
...
public ResultSet deleteReservation(String reservation_id){
