...
public class ReservationControl {
                      ...
                      try { // userの情報を取得するクエリ
                          ...
                          if (rs.next()){
                              ...
                              if ( password_from_db.equals(password)){ //認証成功:データベースのIDとパスワードに一致
                                  ...
                                  res = "ログインできません.ID パスワードかちがいます";

                              }

                          } else { //認証失敗;ユーザIDがデータベースに存在しない

                              res = "ログインできません.ID パスワードが違います。";
    ...
    ////// 施設概要
    public String facilityInformation(String selectedfacility){
        ...
        try {
            ...
            ResultSet rs = mysql.getFacility();
            ...
            while(rs.next()){
            	...
            	if(selectedfacility.equals(facilityname)){
    ...
    public String printReservation(){
    	...
    	if(flagLogin){
    		...
    		res = res + "\n" + id+ " :" + date + " " + start_time + "～" +  end_time + " " +  facility_name;
                     ...
                     if( st.equals(et)){        //開始時刻と終了時刻が等しい
                         ...
                         try {
                             ...
                             ResultSet rs = mysql.selectReservation(rdate, facility);
                               ...
                               boolean ng = true;    //重なりチェックの結果の初期値（重なっていない=false）を設定
                               ...
                               if (!ng){    //重なっていない場合
                                   ...
                                   ResultSet rss = mysql.deleteReservation("2");
                               }
